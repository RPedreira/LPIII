public class ClienteCirculo {
    public static void main(String args []){
        Circulo circulo01 = new Circulo(), circulo02 = new Circulo(3, 4), circulo03 = new Circulo(5), circulo04 = new Circulo(1, 1, 3);
        ...
        if(circulo01.isBiggerThan(circulo04))
            System.out.println("Circulo01 é maior que Circulo04");
        else
            System.out.println("Circulo01 não é maior que Circulo04");
        ...
        if(circulo02.isBiggerThan(circulo04))
            System.out.println("Circulo02 é maior que Circulo04");
        else
            System.out.println("Circulo02 não é maior que Circulo04");
        if(circulo03.isBiggerThan(circulo04))
            System.out.println("Circulo03 é maior que Circulo04");
        else
            System.out.println("Circulo03 não é maior que Circulo04");
        ...
        if(circulo04.isInnerPoint(ponto))
            System.out.println("O ponto está contido no Circulo04");
        else
            System.out.println("O ponto não está contido no Circulo04");
    }
