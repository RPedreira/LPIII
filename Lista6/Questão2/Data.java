public class Data {
    ...
    public void setData(Data novaData){
        setData(novaData.getDia(), novaData.getMes(), novaData.getAno());
    }

    // Os outros métodos setData propostos possuem a mesma assinatura
    ...
    // As funções possuem o mesmo nome e parâmetros iguais (Um inteiro)
    ...
    public int allDaysSinceZero(int dia, int mes, int ano){
        int total, aux;
    ...
    public int allDaysSinceZero(){
        return allDaysSinceZero(getDia(), getMes(), getAno());
    }
    ...
    public int howManyDays(int dia, int mes, int ano){
        ...
        total2 = allDaysSinceZero(dia, mes, ano);
